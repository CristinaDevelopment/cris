...
export class Pages0MarketingResolver {
  ...
  @Mutation(() => Page0, { name: 'createPage0Marketing' })
  createPage(@Args('input') input: CreatePage) {
    return this.pagesService.create(input, 'page0');
  }
  @Mutation(() => Page0, { name: 'updatePage0Marketing' })
  updatePage(
    @Args() id: GetPage,
  ...
  @Mutation(() => [String], { name: 'deletePages0MarketingById' })
  deletePagesById(
  ...
  @Query(() => Page0, { name: 'findPage0Marketing' })
  findPage(@Args() id: GetPage) {
    return this.pagesService.findPage(id, 'page0');
  }

  @Query(() => [Page0], { name: 'findPages0Marketing' })
  findPages() {
    return this.pagesService.findPages('page0');
  }

  @Query(() => [Page0], { name: 'findPages0MarketingByParentId' })
  findPagesByParentId(
