...
@Resolver(() => Page2)
export class Pages2EducationResolver {
  constructor(private readonly pagesService: PagesEducationService) {}

  @Mutation(() => Page2, { name: 'createPage2Education' })
  createPage(@Args('input') input: CreatePage) {
    return this.pagesService.create(input, 'page2');
  }
  @Mutation(() => Page2, { name: 'updatePage2Education' })
  updatePage(
    @Args() id: GetPage,
  ...
  @Mutation(() => String, { name: 'deletePage2Education' })
  deletePage(@Args() id: GetPage) {
    return this.pagesService.deletePage(id, 'page2');
  }

  @Mutation(() => [String], { name: 'deletePages2EducationById' })
  deletePagesById(
  ...
  @Query(() => Page2, { name: 'findPage2Education' })
  findPage(@Args() id: GetPage) {
    return this.pagesService.findPage(id, 'page2');
  }

  @Query(() => [Page2], { name: 'findPages2Education' })
  findPages() {
    return this.pagesService.findPages('page2');
  }

  @Query(() => [Page2], { name: 'findPages2EducationByParentId' })
  findPagesByParentId(
  ...
  @Query(() => ListPage, { name: 'listPages2EducationWithCursor' })
